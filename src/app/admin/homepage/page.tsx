    ...
    <AdminGuard>
      <AdminLayout title="Homepage Content">
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h2 className="font-display text-2xl font-bold mb-3" style={{ color: 'var(--foreground)' }}>Homepage Content</h2>
          <p className="text-sm max-w-sm" style={{ color: 'var(--foreground-muted)', lineHeight: '1.7' }}>Manage hero text, announcement banners, and featured section order on the homepage.</p>
