    ...
    <AdminGuard>
      <AdminLayout title="BookTok Favorites">
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h2 className="font-display text-2xl font-bold mb-3" style={{ color: 'var(--foreground)' }}>BookTok Favorites</h2>
          <p className="text-sm max-w-sm" style={{ color: 'var(--foreground-muted)', lineHeight: '1.7' }}>Manage the BookTok Favorites section — trending titles from the TikTok reading community.</p>
